...
url="https://github.com/trapexit/mergerfs/releases/download/2.28.3/mergerfs_2.28.3.ubuntu-bionic_amd64.deb" # Replace this link with latest version or different OS
