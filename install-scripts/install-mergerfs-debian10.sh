...
url="https://github.com/trapexit/mergerfs/releases/download/2.28.3/mergerfs_2.28.3.debian-buster_amd64.deb" # Replace this link with latest version or different OS
